...
export class WordPressMCPServer {
  ...
  private registerHandlers(): void {
    ...
    this.server.tool(
      ...
      async (args) => {
        try {
          const params = args as import('./types/mcp.types.js').GetOrdersStatsParams;
          ...
          return { content: [{ type: 'text', text: JSON.stringify(stats) }] } as any;
        } catch (error) {
          const handled = ErrorHandler.handle(error);
          return { content: [{ type: 'text', text: handled.message }], isError: true } as any;
        }
    ...
    this.server.tool(
      ...
      async (args) => {
        try {
          const params = args as import('./types/mcp.types.js').GetProductStatsParams;
          const credentials = await new AuthService().authenticateWooCommerce(params);
          const { WooCommerceReportsService } = await import('./services/woocommerce-reports.service.js');
          const svc = new WooCommerceReportsService(credentials);
    ...
    this.server.tool(
      ...
      async (args) => {
        try {
          const params = args as import('./types/mcp.types.js').AnalyzeSalesParams;
          const credentials = await new AuthService().authenticateWooCommerce(params);
          const { WooCommerceReportsService } = await import('./services/woocommerce-reports.service.js');
          const svc = new WooCommerceReportsService(credentials);
          ...
          return { content: [{ type: 'text', text: JSON.stringify(response) }] } as any;
        } catch (error) {
          const handled = ErrorHandler.handle(error);
          return { content: [{ type: 'text', text: handled.message }], isError: true } as any;
        }
    ...
    this.server.tool(
      ...
      async (args) => {
        try {
          const params = args as import('./types/mcp.types.js').GetRevenueStatsParams;
          const credentials = await new AuthService().authenticateWooCommerce(params);
          const { WooCommerceReportsService } = await import('./services/woocommerce-reports.service.js');
          const svc = new WooCommerceReportsService(credentials);
    ...
    this.server.tool(
      ...
      async (args) => {
        try {
          const params = args as import('./types/mcp.types.js').GetTopProductsParams;
          const credentials = await new AuthService().authenticateWooCommerce(params);
          const { WooCommerceReportsService } = await import('./services/woocommerce-reports.service.js');
          const svc = new WooCommerceReportsService(credentials);
          const rows = await svc.getTopProducts({ range: params.range, after: params.after, before: params.before, limit: params.limit });
          return { content: [{ type: 'text', text: JSON.stringify(rows) }] } as any;
        } catch (error) {
          const handled = ErrorHandler.handle(error);
          return { content: [{ type: 'text', text: handled.message }], isError: true } as any;
        }
